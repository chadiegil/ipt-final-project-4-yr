<div>
    <div class="container mt-2">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class='btn  btn-sm float-end mb-2' style="background-color: #2c70b1; color:white;" data-toggle="modal"
                data-target="#modal-permissions">Create New Permission</div>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" class="btn btn-primary" id="ic" title="Edit"
                                    data-toggle="modal" data-target="#update-modal-permissions"
                                    wire:click="editPermissions({{ $permission->id }})"><i class=" fa fa-gear"></i></a>
                                <a href="" class="btn btn-danger" id="ic" title="Delete"
                                    data-toggle="modal" data-target="#delete-modal-permissions"
                                    wire:click="delete({{ $permission->id }})"><i class=" fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
