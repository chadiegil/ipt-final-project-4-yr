<div>
    <div class="container mt-2">
        <div class="container d-flex align-items-center justify-content-between ">
            ...
            <div class='btn btn-primary btn-sm mb-2' data-toggle="modal" data-target="#modal-roles">Create New
                Role
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" class="btn btn-warning" id="ic" title="Edit"
                                    data-toggle="modal" data-target="#update-modal-roles"
                                    wire:click="editRoles({{ $role->id }})"><i class=" fa fa-edit"></i></a>
                                <a href="" class="btn btn-danger" id="ic" title="Delete"
                                    data-toggle="modal" data-target="#delete-modal-roles"
                                    wire:click="delete({{ $role->id }})"><i class=" fa fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    @if ($roles->count() == 0)
