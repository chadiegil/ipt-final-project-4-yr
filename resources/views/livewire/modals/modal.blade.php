    ...
    <div wire.ignore.self class="modal fade" id="click" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-ms" role="document">
            <div class="modal-content " id="modall">
                ...
                <select name="title" class="form-select" wire:model.defer="title" style="background-color: #097969">
                ...
                <div class="modal-footer">
                    <button type="button" id="submit-button" class="btn form-control" style="background-color: #097969"
